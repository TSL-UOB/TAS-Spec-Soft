...
\textit{Add short introduction}
\begin{itemize}
	\item RQ5.1: The gripper \emph{shall} be environmentally sustainable. The use of a recycled gripper may make its manufacturers or the company deploying it \textit{look like} they care for the environment and so appear more trustworthy, which may in turn increase public trust in them. However, there is a risk that such a system may not perform as well as or may degrade more rapidly than a system made of virgin material, hence making it more likely for items to be dropped or damaged. If these items were food, the risk of food waste would increase, with detrimental implications for the environment. Thus, unless the reliability requirements illustrated above are met by design, the use of a recycled gripper could be a form of “greenwashing” \cite{delmas2011drivers}    
	\item RQ5.2: The gripper \emph{shall} avoid distressing human workers. While technical requirements aim to prevent \textit{physical} harm, considerations of system safety should expand to the potential for \textit{psychological} harms \cite{Porter2022}. By replicating a human feature (fingers/hand) and behaviour (gripping), a soft robotic gripper risks producing an uncanny valley effect \cite{moore2012bayesian}, which causes humans to feel distressed in interactions with robots that mimic, but are not close enough to, human or zoomorphic features and demeanours. User studies should be undertaken to identify gripper shapes that are acceptable to humans, whilst also aiming for optimal gripping.  
	\item RQ5.3: The gripper \emph{shall} avoid exploiting humans’ trust heuristics. Because of their biomimetic features, soft robots risk exploiting humans’ trust heuristics, i.e. cognitive shortcuts that make humans trust things they are already familiar with \cite{Manzini}. Because soft robots present many safety loopholes \cite{abidi2017intrinsic}, trust in a soft gripper could be misplaced if it was only based on a sense of familiarity with it, hence  posing humans in the use case space at risk of harm. To reduce such a risk, the robot area should be clearly separated from the space accessible to humans.
	\item RQ5.4: The gripper \emph{shall} allow fair treatment of current workers. Increase in warehouse automation through the deployment of soft grippers may improve efficiency in the manufacturing of goods, and in turn lead to decreased costs to the advantage of consumers; it could also relieve workers from routine or physically demanding tasks. However, in the transition to increased automation current human pickers may be treated unfairly, as automation may reduce employment opportunities or dramatically change the skills required of employees. Company policies should be implemented to retrain or upskill current workers; at a broader societal level, automation trends should be used to inform investments in education, and so equip younger generations with those skills needed by the rapidly changing labour market \cite{georgieff2021happened, nedelkoska2018automation}
\end{itemize}
