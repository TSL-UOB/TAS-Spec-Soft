...
On the one hand, most requirements of the specification contain numeric tolerances. 
...
By doing this, we show what is the difference between a high-level requirement and its verifiable version. 
...
With the advancement of soft robotics as an emerging technology, flexible devices are created by engineers to be used in different applications like grocery picking, space exploration, surgery, and prosthetics. 
...
Furthermore, most existing works only describe some parameters of the end-effector. 
Therefore, our study, which is explored using a pick-and-place tasks of grocery items, proposed an extensive specification for a soft gripper covering several non-functional properties of predictability, reliability, adaptability, safety, ethics, and regulations. 
In addition, our study promoted the verifiability of a soft gripper as a first-class design objective. 
We adopted several techniques to ensure verifiability and identified several design guidelines on formulating verifiability requirements. 
