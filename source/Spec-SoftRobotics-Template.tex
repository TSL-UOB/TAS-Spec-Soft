...
Human values inform the design and use of technologies, and the resulting distribution of benefits and burdens, thus affecting system trustworthiness. Rather than \emph{describing} whether people \emph{trust} a technology, ethicists \emph{prescribe} whether they \emph{should trust} it because it is or is not trustworthy. Below are the ethics requirements for specifying for trustworthiness in a soft gripper in pick-and-place tasks.
\begin{itemize}
