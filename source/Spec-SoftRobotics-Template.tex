...
\section{SPECIFICATION OF A SOFT GRIPPER}\label{specification-gripper}
	...
	In this manner, this work not only provides a wide-ranging specification for a pick-and-place application, but also provides illustrations of how to formulate verifiable requirements for soft robotics. % requirements verifiable.
